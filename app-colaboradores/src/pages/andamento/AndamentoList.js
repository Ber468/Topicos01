...
const AndamentoList = (props) => {
  ...
  return (
    <div>
      <div>
        <h4 style={{textAlign:'center'}}>Listagem de Andamentos</h4>
        ...
        <div className="card">
          <DataTable value={props.andamentos} selectionMode="single" responsiveLayout="scroll"
            ...
            <Column field="Atividade.descricao" header="Andamento" sortable filter></Column>
