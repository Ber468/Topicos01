          ...
          <div className="container" style={{marginLeft: "38%",textAlign:"center"}}>
            <div className="p-fluid grid formgrid">
              <div className="field col-3 md:col-4">
                <label style={{textAlign: "center"}} htmlFor="nome">Nome</label>
                <InputText
                  name="nome"
                  {...register("nome", {
            ...
            <div className="p-fluid grid formgrid">
              <div className="field col-3 md:col-4">
                <label style={{textAlign: "center"}} htmlFor="senha">Senha</label>
                <InputText
                  name="senha"
                  {...register("senha", {})}
            ...
            <div className="p-fluid grid formgrid">
              <div className="field col-3 md:col-4">
                <label style={{textAlign: "center"}} htmlFor="contraSenha">Contra Senha</label>
                <InputText
                  name="contraSenha"
