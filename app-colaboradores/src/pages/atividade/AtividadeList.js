...
const AtividadeList = (props) => {
  ...
  return (
    <div>
      <div>
        <h4 style={{textAlign:'center'}}>Listagem de Atividades</h4>
        ...
        <div className="card">
          <DataTable value={props.atividades} selectionMode="single" responsiveLayout="scroll"
            ...
            <Column field="Requisicao.descricao" header="Requisição" sortable filter></Column>
